...
<body onload="refresh()">
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        ...
        <main role="main">
                <div class="jumbotron">
                  ...
                  <div class="container">
                    <form id="myForm" method="POST" action="modifierEtudiants.php">

                       <div class="form-group">
                        <label for="cin">CIN:</label><br>
                        <input type="text" id="cin" name="cin" value="<?= $et['cin']?>" class="form-control" readonly/>
                       </div>
                        <div class="form-group">
                        <label for="nom">Nom:</label><br>
                        <input type="text" id="nom" name="nom" value="<?= $et['nom'] ?>" class="form-control" required autofocus>
                       </div>
                        <div class="form-group">
                        <label for="prenom">Prénom:</label><br>
                        <input type="text" id="prenom" name="prenom" value="<?= $et['prenom'] ?>" class="form-control" required>
                       </div>
                        <div class="form-group">
                           <label for="email">Email:</label><br>
                           <input type="email" id="email" name="email" value="<?= $et['email'] ?>" class="form-control" required>
                          </div>
                        <div class="form-group">
                        <label for="classe">Classe:</label><br>
                        <input type="text" id="classe" name="classe" value="<?= $et['Classe'] ?>" class="form-control" required pattern="INFO[1-3]{1}-[A-E]{1}"
                        placeholder="Pattern INFOX-X. Par Exemple: INFO1-A, INFO2-E, INFO3-C">
                       </div>
      ...
      function modifier()
    {
        ...
        var url="http://localhost/projet_hamdi/modifierEtudiants.php";
