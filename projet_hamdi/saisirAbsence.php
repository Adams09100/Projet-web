...
<div class="form-group">
  ...
  <select id="module" name="module"  class="custom-select custom-select-sm custom-select-lg">
      ...
      <option value="1-INFOB">Analyse Numérique</option>
      <option value="1-INFOB">Math ING</option>
      <option value="1-INFOB">Francais</option>
      <option value="1-INFOB">Anglais</option>
      <option value="1-INFOB">Programmation</option>
  </select>
  </div>

<table id="demo" rules="cols" frame="box">
