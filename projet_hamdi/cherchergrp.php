...
<main role="main">
        <div class="jumbotron">
            <div class="container">
              <h1 class="display-4">Chercher un groupe</h1>
            </div>
          </div>


<div class="container">
 <form id="myForm" method="POST" action="recherche2.php">
 <div id="demo"></div>
     <!--Nom-->
...
<script>
    function refresh() {
      ...
      var url ="http://localhost/projet_hamdi/recherche2.php";
	...
	function myFunction(response){
		...
		var i;
		var out=" <tr><th> Nom/th><th>Nombre d'étudiants</th>";
